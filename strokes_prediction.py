...
Di cell ini, kita akan melakukan pengolahan data seperti membuang gender yang tidak diperlukan dan membuat attribute id pada dataset.
"""
...
Pada tahap ini, kita akan melakukan transformasi data agar data yang digunakan untuk model jaul lebih baik dan meningkatkan performa model. Transformasi data yang akan dilakukan antara lain adalah Encoding terhadap fitur kategorikal, data balancing, splitting data, dan standarisasi.
